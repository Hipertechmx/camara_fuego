...
namespace esphome{
  ...
  // ... procesamiento previo del sensor
  ...
  // Interpolación y aplicación de filtros
  interpolate_image(pixels, 24, 32, pixels_2, 72, 96);
  apply_threshold(pixels_2, 96, 72, 40.0);
  apply_edge_detection(pixels_2, 96, 72);
  mark_hotspot(pixels_2, 96, 72);
